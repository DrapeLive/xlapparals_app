...
class EditDeliveryOptionsCard extends StatelessWidget {
  final OrderDetails order;
  const EditDeliveryOptionsCard(this.order, {super.key});
  ...
  Future<void> _pickDate(BuildContext context) async {
    ...
    if (selected != null && context.mounted) {
      context.read<EditOrderBloc>().add(PickEditDeliveryDate(selected));
    }
  }
  ...
  Future<void> _showTransports(
    ...
    if (selected != null && context.mounted) {
      context.read<EditOrderBloc>().add(SelectEditTransport(selected));
    }
  }
